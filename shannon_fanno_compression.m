% this file performing Shannon fano comprassion technique  %
       % created by dharmendra (BT20ECE074) %
       % date - 22/02/2023 %

probabilities = [0.3, 0.3, 0.2, 0.2];   %probabilities

[codewords, avglen] = shannon_fano(probabilities);     %calling function
disp(codewords);
disp(avglen);
